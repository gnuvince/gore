...
fn var_decl_ok() {
    ...
    assert_eq!(None, parse_var_decl(b"var (x int; y float64;)"));
    assert_eq!(None, parse_var_decl(b"var (x, y int; z float64;)"));
    assert_eq!(None, parse_var_decl(b"var (x int; y, z float64;)"));

    assert_eq!(None, parse_var_decl(b"var (x = a; y = b;)"));
    assert_eq!(None, parse_var_decl(b"var (x, y = a, b; z = c;)"));
    assert_eq!(None, parse_var_decl(b"var (x = a; y, z = b, c;)"));

    assert_eq!(None, parse_var_decl(b"var (x int = a; y float64 = b;)"));
    assert_eq!(None, parse_var_decl(b"var (x, y string = a, b; z []int = c;)"));
    assert_eq!(None, parse_var_decl(b"var (x bool = a; y, z rune = b, c;)"));
}
